...
/**
 ...
 @param selectNumber 选中的标题的index
 */
...
/**
 ...
 @param XSSegmentedView 滑动的实例对象
 @param integer         被选中的标题的index
 */
- (void)xsSegmentedView:(XSSegmentedView *)XSSegmentedView selectTitleInteger:(NSInteger)integer;
